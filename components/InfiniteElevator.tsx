...
{tier:2,title:'ATM',desc:'お金を預け、次の遭遇時に5倍で受け取れる特殊端末。',bg:'radial-gradient(circle at 50% 45%,rgba(34,211,238,.26),transparent 36%),linear-gradient(180deg,#102631,#071014)',accent:'#67e8f9'},
